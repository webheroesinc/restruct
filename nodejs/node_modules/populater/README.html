...
<ul>
<li><a href="#sec-1">1. Basic Usage</a></li>
<li><a href="#sec-2">2. Define a method</a></li>
<li><a href="#sec-3">3. Using an alternative context for methods</a></li>
</ul>
</div>
</div>
...
<pre class="src src-javascript">var populater        = require('populater');
var data             = {
    text: "World"
};
...
<h2 id="sec-2"><span class="section-number-2">2</span> Define a method</h2>
...
<h2 id="sec-3"><span class="section-number-2">3</span> Using an alternative context for methods</h2>
...
<p class="date">Created: 2017-09-19 Tue 20:22</p>
